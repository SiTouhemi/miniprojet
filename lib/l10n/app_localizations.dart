...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'view_weekly_menu': 'View this week\'s menu',
      ...
      'qr_expires_in': 'Expires in {minutes} minutes',
      ...
      'scan_success': 'Reservation Validated Successfully',
      'scan_invalid': 'Invalid QR Code',
      'scan_expired': 'QR Code Expired',
      'scan_already_used': 'Reservation Already Used',
      'student_information': 'Student Information',
      'student_details': 'Student: {name} - {class}',
      'meal_details': 'Meal: {type} at {time}',
    ...
    'fr': {
      ...
      'qr_expires_in': 'Expire dans {minutes} minutes',
      'qr_expired': 'Code QR Expiré',
      'regenerate_qr': 'Générer un Nouveau QR',
      'no_qr_code': 'Aucun Code QR Disponible',
      ...
      'scan_success': 'Réservation Validée avec Succès',
      'scan_invalid': 'Code QR Invalide',
      'scan_expired': 'Code QR Expiré',
      'scan_already_used': 'Réservation Déjà Utilisée',
      'student_information': 'Informations Étudiant',
      'student_details': 'Étudiant: {name} - {class}',
      'meal_details': 'Repas: {type} à {time}',
    ...
    'ar': {
      ...
      'qr_expires_in': 'ينتهي في {minutes} دقيقة',
      'qr_expired': 'انتهت صلاحية رمز الاستجابة السريعة',
      'regenerate_qr': 'إنشاء رمز جديد',
      'no_qr_code': 'لا يوجد رمز استجابة سريعة',
      ...
      'scan_success': 'تم التحقق من الحجز بنجاح',
      'scan_invalid': 'رمز استجابة سريعة غير صالح',
      'scan_expired': 'انتهت صلاحية رمز الاستجابة السريعة',
      'scan_already_used': 'تم استخدام الحجز بالفعل',
      'student_information': 'معلومات الطالب',
      'student_details': 'الطالب: {name} - {class}',
      'meal_details': 'الوجبة: {type} في {time}',
      'scan_another': 'مسح آخر',
      'scan_history': 'سجل المسح',
      'no_scans_yet': 'لا توجد عمليات مسح حتى الآن',
