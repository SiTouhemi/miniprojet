...
class ReservationconfirmeModel
  ...
  Future<void> loadReservationData(String reservationId) async {
    ...
    try {
      ...
      AppLogger.e('Error loading reservation data', error: e, tag: 'ReservationconfirmeModel');
  ...
  String getPaymentStatus() {
    return reservation?.status == 'confirmed' || reservation?.status == 'used' ? 'Payé' : 'En attente';
  }
