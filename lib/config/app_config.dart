...
class AppConfig {
  ...
  static const int priceDecimalPlaces =
      3; // Changed to 3 for Tunisian Dinar precision
  ...
  static const Map<String, Map<String, String>> restaurantHours = {
    'lunch': {
      'start': '11:40',
      'end': '14:00',
    },
  ...
  static const int timeSlotDurationMinutes = 20;
  static const int defaultSlotCapacity = 25; // Smaller capacity per 20-min slot
