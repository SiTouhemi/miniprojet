...
/// Build an Admin Panel for the ISETCOM restaurant reservation system in
/// FlutterFlow focused on full admin functionality.
///
/// Admin can: manage all Plats for both déjeuner and dîner (create, edit,
/// delete), manage time slots (add, edit capacity, deactivate, delete), view
/// and manage all reservations (search, filter, view details, validate
/// tickets, mark as used, cancel or modify student reservations), manage user
/// accounts with full CRUD (create, edit roles, deactivate, delete), view
/// system statistics (daily reservations, occupancy, remaining seats, ticket
/// status), monitor payment status via D17, and access activity logs showing
/// all actions performed by admins or staff. Output: full FlutterFlow widget
/// tree with all required admin features.
...
class _AdminDashboardWidgetState extends State<AdminDashboardWidget> with RoleAwareMixin {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      await LogoutDialog.handleLogout(context);
                    },
                    icon: Icon(
                      Icons.logout,
                      color: Color(0xFF4B986C),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF928163), Color(0xFF4B986C)],
                      stops: [0.8, 1.0],
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          ...
                          context.pushNamed('MealManagement');
                        },
                        child: Material(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: EdgeInsets.all(8.0),
                            child: Text(
                              _getStatusDisplayName(reservation.status),
                              style: FlutterFlowTheme.of(context)
                                  .labelSmall
                                  .override(
                                    font: GoogleFonts.plusJakartaSans(
    ...
    try {
      if (reservation.userId.isNotEmpty) {
        final userDoc = await FirebaseFirestore.instance
            ...
            .get();
        if (userDoc.exists) {
          return UserRecord.fromSnapshot(userDoc);
        }
      }
      return null;
    } catch (e) {
  ...
  Color _getStatusColor(String status) {
    switch (status.toLowerCase()) {
      case 'confirmed':
        return Color(0xFF336A4A);
      case 'pending':
        return Color(0xFFF3C344);
      case 'used':
        return Color(0xFF6D604A);
      case 'cancelled':
