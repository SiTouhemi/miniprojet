...
/// Après une réservation réussie, cette page affiche le QR code unique
/// correspondant au ticket du repas réservé.
///
/// L’étudiant peut présenter ce code à l’entrée du restaurant pour valider
/// son accès.
/// L’écran indique aussi les détails de la réservation : type de repas
/// (déjeuner ou dîner), date, créneau horaire et statut du paiement.
...
class ReservationconfirmeWidget extends StatefulWidget {
  ...
  @override
  State<ReservationconfirmeWidget> createState() =>
      _ReservationconfirmeWidgetState();
}

class _ReservationconfirmeWidgetState extends State<ReservationconfirmeWidget> {
  late ReservationconfirmeModel _model;
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Votre ticket repas a été généré avec succès',
                      textAlign: TextAlign.center,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Veuillez arriver à l\'heure de votre créneau pour éviter l\'annulation de votre réservation.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        font: GoogleFonts.inter(
